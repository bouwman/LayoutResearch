...
class ConsentDocument: ORKConsentDocument {
    ...
    let ipsum = [
        ...
        "Only UCL researchers working with Tassilo Bouwman will analyse these data. With your permission, we may want to use this data for teaching, conferences, presentations, publications, and/or thesis work.",
